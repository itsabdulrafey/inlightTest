...
const cardsData = [
  { id: 0, color: 'white',text: 'skyblue',image:imagess,data:{
    heading1:"eFX ",
    heading2:"Plus HD",
    heading3:"Est. 199$*",
  ...
  { id: 1, color: 'black',text: 'salmon', image:images2,data:{
    heading1:"eFX ",
    heading2:"Edge",
    heading3:"Est. 299$*",
    heading4:"The Standard eFX Trades",
  ...
  { id: 2, color: '#444444',text: 'lightgreen',image:images3,data:{
    heading1:"eFX ",
    heading2:"Alpha",
    heading3:"Est. 399$*",
    heading4:"The Standard eFX Trades",
...
"Maintains a stable portfolio of 60+ trades"
  ...
  { id: 3, color: '#4F805D',text: 'khaki',image:images4 ,data:{
    heading1:"eFX ",
    heading2:"Apex",
    heading3:"Est. 899$*",
    heading4:"The Standard eFX Trades",
...
const CardContainer = () => {
  ...
  const textStyle = (index, length, color) => ({
    //  width: '100px',
    //  height: '100px',
     position: 'absolute',
     left:0,
  ...
  return (
     <>    
     <div style={{ width: "100%",display:"flex",justifyContent:"space-evenly",height:300}}>
     ...
     <AnimatePresence>
        {activeCards.map((card, index) => (
          <motion.div
            ...
            style={textStyle(index, activeCards.length, card.color,card.text)}
           
          >
            {/* Card {card.id + 1} */}
            {/* <div className="h-[683px] w-[683px] md:h-auto p-5 rotate-[-30deg] bg-blue_gray-600 relative rounded-[16px]"> */}
                  
                      <div onClick={handleCardClick} style={{backgroundColor:"white",maxWidth:800,height:700}}  >
                    <div className="flex justify-between gap-5">
                      <div className="flex">
                        <Text size="xl" as="p" className="mt-[9px] mb-2 !text-white-A700 tracking-[4.80px] uppercase">
                          <span className="text-black-900">{card?.data?.heading1}</span>
                          <span className="text-black-900 font-bold">{card?.data?.heading2}</span>
                        </Text>
                      </div>
                      <div className="flex py-[13px]">
                        <Heading as="h5" className="!text-black-900 tracking-[4.00px] uppercase">
                        {card?.data?.heading3}
                        </Heading>
                      </div>
                    </div>
  ...
  return(
    <>
                    ...
                    <div className="flex justify-between items-center mt-[50px] gap-5">
                      ...
                      <Heading size="lg" as="h6" className="!text-gray-800 tracking-[3.20px] uppercase">
                        JOIN WAITLIST  →
                      </Heading>
                    </div>
                  </div>
     ...
     <div id="cardContainer" style={{ width: "45%",height:400,position:"relative"}} onClick={handleCardClick}>
      ...
      <AnimatePresence>
        {activeCards.map((card, index) => (
          <motion.div
            ...
            // alt="shutterstock"
            variants={cardVariants}
            style={cardStyle(index, activeCards.length, card.color,card.text)}
          >
            {/* Card {card.id + 1} */}
            {/* <div className="h-[683px] w-[683px] md:h-auto p-5 rotate-[-30deg] bg-blue_gray-600 relative rounded-[16px]"> */}
